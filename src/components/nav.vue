<template>
	<div class="nav">
		<div class="nav-a" >
			...
			<router-link @click="nav = 5"  class="nav-b" :class="{'nav-active' : nav == 5}" to="/">客户服务</router-link>
			<router-link @click="nav = 6"  class="nav-b" :class="{'nav-active' : nav == 6}" to="/" style="border: none;">手机学掌门</router-link>
		</div>
	</div>
</template>
